  ...
  useEffect(() => {
    ...
    const getNavSection = async () => {
      try {
        const {
          data: { data },
        } = await axios.post(base_url, { postData: "NAV_SECTION" });
        setNavSection(data);
      } catch (error) {}
    };
    getTopBanner();
            ...
            return (
              <>
                ...
                <TopItem>
                  ...
                  <span>
                    {obj.address.map((addrr) => (
                      <span key={addrr}>{addrr}</span>
                    ))}
                  </span>
                </TopItem>
              </>
        ...
        <ul>
          ...
          <li>
            ...
            <Line
              transition={{ duration: 0.75 }}
              initial={{ width: "0%" }}
              animate={{ width: hash === `#ourOffering` ? "90%" : "0%" }}
            />
          </li>
          <li>
            ...
            <Line
              transition={{ duration: 0.75 }}
              initial={{ width: "0%" }}
              animate={{ width: hash === `#curedVanilla` ? "90%" : "0%" }}
            />
          </li>
          <li>
            ...
            <Line
              transition={{ duration: 0.75 }}
              initial={{ width: "0%" }}
              animate={{ width: hash === `#initiatives` ? "90%" : "0%" }}
            />
          </li>
          <li>
